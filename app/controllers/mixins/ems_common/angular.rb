  ...
  module EmsCommon
    module Angular
      ...
      def set_ems_record_vars(ems, mode = nil)
        ...
        if ems.kind_of?(ManageIQ::Providers::Openstack::CloudManager) || ems.kind_of?(ManageIQ::Providers::Telefonica::CloudManager) || ems.kind_of?(ManageIQ::Providers::Openstack::InfraManager)
